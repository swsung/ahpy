...
>>> from ahpy.core import calculate_weights, calculate_consistency
>>> arr1 = [[1,3,5], [1./3., 1,3], [1./5., 1./3., 1]] 
>>> print  calculate_weights(arr1, rounding=4)
[Decimal('0.6370'), Decimal('0.2583'), Decimal('0.1047')]
>>> print calculate_consistency(arr1)
0.0213950503101
...
... [1./4., 1./3., 1./2., 1    , 2],
... [1./5., 1./4., 1./3., 1./2., 1]]
>>> print calculate_weights(arr2,rounding=3)
[Decimal('0.419'), Decimal('0.263'), Decimal('0.160'), Decimal('0.097'), Decimal('0.062')]
>>> print calculate_consistency(arr2)
0.0137258582623
"""
